...
const polyphemusRay1 = extend(Weapon, "moth-units-overload-ray", {
  x: 9,
  y: 19,
  rotate: true
});

const polyphemusRay2 = extend(Weapon, "moth-units-overload-ray", {
  x: 20,
  y: 16,
  rotate: true
});

const polyphemusRay3 = extend(Weapon, "moth-units-overload-ray", {
  x: 13,
  y: -1,
  rotate: true
});
